...
int main()
{
	...
	int field[MASS1][MASS2]; //задаем матрицу пол€ дл€ перемещений
	...
	cout << "¬ведите программу : ";

	cin >> prog;

	for (int i = 0; i < MASS1; i++) {			//заполн€ем матрицу нул€ми
	...
	cout << " оличество шагов робота: ---|" << bot1.countStep << "|---" << endl;
